/-!
# AsymSecCertificate Common helpers
...
per-block PSD witness file under `DaveyThesis2024/AsymSecCertificate/Block*.lean`.
...
namespace Davey2024.AsymSecCertificate
...
end Davey2024.AsymSecCertificate
