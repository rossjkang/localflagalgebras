...
/-
  ...
  Layer 12: the mask list, as a literal.
...
/-- The 1 mask words of layer 12, as a literal: a slice of it is then a walk
...
theorem M_eq : msGen 12 = M := by decide +kernel

theorem M_residual : M.drop 1 = [] := by decide +kernel
...
theorem stepM {a b c : Nat} (h : a + b = c) {x y z : Nat}
    (hc : msCnt 12 ((M.drop a).take b) = (x, 0))
    (hr : msCnt 12 (M.drop c) = (y, 0))
    (hs : x + y = z) :
    msCnt 12 (M.drop a) = (z, 0) := by
  rw [msCnt_peel 12 M a b c h, hc, hr]
  subst hs
  rfl

end Delta4Gen.L12

#print axioms Delta4Gen.L12.M_eq
#print axioms Delta4Gen.L12.M_residual
#print axioms Delta4Gen.L12.stepM
