...
/-
  ...
  Layer 0: the mask list, as a literal.
...
/-- The 0 mask words of layer 0, as a literal: a slice of it is then a walk
...
theorem M_eq : msGen 0 = M := by decide +kernel
...
theorem stepM {a b c : Nat} (h : a + b = c) {x y z : Nat}
    (hc : msCnt 0 ((M.drop a).take b) = (x, 0))
    (hr : msCnt 0 (M.drop c) = (y, 0))
    (hs : x + y = z) :
    msCnt 0 (M.drop a) = (z, 0) := by
  rw [msCnt_peel 0 M a b c h, hc, hr]
  subst hs
  rfl

end Delta4Gen.L0

#print axioms Delta4Gen.L0.M_eq
#print axioms Delta4Gen.L0.M_residual
#print axioms Delta4Gen.L0.stepM
